          ...
          {actions.map((action) => {
              ...
              return (
                <DropdownMenu key={action.id}>
                  <DropdownMenuTrigger asChild>
                    <button className="flex flex-col items-center justify-center w-20 h-16 rounded-2xl text-gray-300 hover:text-yellow-400 hover:bg-zinc-800 transition-all">
                      <Icon size={22} />
            ...
            return (
              <button
                ...
                className={`flex flex-col items-center justify-center w-20 h-16 rounded-2xl transition-all duration-300 ${
                  isLiked
                    ? "text-yellow-400"
