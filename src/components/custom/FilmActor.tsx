...
interface FilmActorProps {
    filmActorData: FilmData[] | null;
}
...
export default function FilmActor({ filmActorData }: FilmActorProps) {
    ...
    const filmsByYear = filmActorData.reduce((acc: Record<string, FilmData[]>, film) => {
